...
export const dayCloseRequests = pgTable(
  "day_close_requests",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(() => users.id).notNull(),
    ...
    ISRoutineLog: text("is_routine_log"), // Renamed from adminRoutineLog
    ISGeneralLog: text("is_general_log"), // Renamed from adminGeneralLog
    createdAt: timestamp("created_at").defaultNow().notNull(),
...
export const groups = pgTable("groups", {
  id: serial("id").primaryKey(),
  name: text("name").notNull(),
  conversation_sid: text("conversation_sid"), // Twilio Conversation SID
