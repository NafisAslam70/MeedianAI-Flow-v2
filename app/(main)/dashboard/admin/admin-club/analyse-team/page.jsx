...
export default function AnalyseTeamPage() {
  ...
  const canView = isAdmin || adminClubGrant === true;
  ...
  const programsToShow = programs.slice(-4);
  ...
  const ptStatusEntries = useMemo(() => Array.from(ptSummary.statuses.entries()), [ptSummary.statuses]);
  const submittedCount = ptSummary.statuses.get("submitted") || 0;
    ...
    <div className="space-y-6 p-4 md:p-6">
      <header className="space-y-2 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-semibold text-slate-900">Analyse Meed Team</h1>
          <p className="mt-1 text-sm text-slate-600">
            Daily control room for leadership. Review PT completion, campus movement, MRI journals, and attendance health.
          </p>
        </div>
            ...
            <div className="grid gap-4 md:grid-cols-[2fr_1fr]">
              ...
              <div className="space-y-4 rounded-xl border border-slate-100 bg-slate-50 p-4">
                ...
                <Link
                  ...
                  className="block rounded-lg bg-teal-600 px-4 py-2 text-center text-sm font-semibold text-white transition hover:bg-teal-700"
                >
                  Open PT Assistant
                </Link>
                <Link
                  href="/dashboard/admin/manageMeedian/mri-reports/pt"
                  className="block rounded-lg border border-slate-200 px-4 py-2 text-center text-sm font-semibold text-slate-700 transition hover:border-teal-200 hover:text-teal-700"
                >
                  Manage PT Template
                </Link>
              </div>
          ...
          {teamLoading ? (
            ...
            <div className="space-y-4">
              <div className="text-xs text-slate-500">
                Viewing MRI journal for <span className="font-semibold text-slate-700">{selectedMemberName}</span> on{" "}
                      ...
                      >
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
                          ...
                          <div className="text-right text-xs text-slate-500">
                            ...
                            <div className="font-semibold text-slate-700">{formatDuration(durationMinutes)}</div>
                          </div>
                        </div>
                        {session.note && (
      ...
      <section className="space-y-3">
        ...
        {hasMorePrograms && (
          <p className="text-xs text-slate-500">
            Showing last {programsToShow.length} programs. Visit Manage Meedian for the full list.
          </p>
        )}
      </section>
    </div>
