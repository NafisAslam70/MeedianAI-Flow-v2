    ...
    <footer className={`relative overflow-hidden bg-gray-900 text-white min-h-20 ${className}`}>
      ...
      <div className="relative z-10 w-full max-w-screen-2xl mx-auto px-3 pt-2 pb-9 min-h-20 flex items-center">
        <div className="w-full grid grid-cols-1 md:grid-cols-3 items-center gap-2">
          ...
          >
            <span className="whitespace-nowrap">Founder: <span className="font-semibold text-cyan-200"> Mr Aslam Kamal</span></span>
            <span className="mx-1">·</span>
            <span className="whitespace-nowrap">Founder (Rev.): <span className="font-semibold text-cyan-200">Shaikh Zifan</span></span>
          </motion.div>
          ...
          >
            <span>© 2025 Proudly designed by</span>
            <a
